...
public class SanityTest_FoodOrdering {
	...
	private static final Logger logger = LogManager.getLogger(SanityTest_FoodOrdering.class);
	 ...
	 * 		Given: Client is an registered user at 10bis 
	 * 		When: searching for a Restaurant in search bar 
	 *  	Then: entering the restaurant page after searching for restaurant and making a successful order
	 */
	
	@Test(priority = 3, enabled = true, description = "Filing up an Food order")
	public void FillingFoodOrder() throws InterruptedException, IOException, ParserConfigurationException, SAXException {
	
		main.mealOrder();
		logger.info("Successfully ordered meal and go to payment page");
